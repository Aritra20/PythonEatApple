...
class SNAKE:
    def __init__(self):
        ...
        self.background_sound = pygame.mixer.Sound('background.mp3')
...
class MAIN:
    def __init__(self): 
        self.snake = SNAKE()
        self.fruit = FRUIT()
        self.snake.play_background_sound()
    ...
    def draw_score(self):
        ...
        pygame.draw.rect(screen,(81, 247, 52),bg_rect)
